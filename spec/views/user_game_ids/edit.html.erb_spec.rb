...
RSpec.describe "user_game_ids/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit user_game_id form" do
    render

    assert_select "form[action=?][method=?]", user_game_id_path(@user_game_id), "post" do
